...
class CenterController extends Controller
{
    ...
    {
        $centers = Center::all();
        return view('operator.centers.index', compact('centers'));
    }
    ...
    {
        return view('operator.centers.create');
    }
    ...
    public function edit($id)
    {
        ...
        return view('operator.centers.edit', compact('center'));
    }
    ...
    {
        return view('operator.centers.update-vial', compact('center'));
    }
